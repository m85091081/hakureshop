...
import hashlib
import logging
from muMDAU_app.pyallpay.utilities import do_str_replace
'''
    Configure your personal setting in setting.py
'''
from muMDAU_app.pyallpay.setting import HASH_IV, HASH_KEY
from muMDAU_app.pyallpay.setting import AIO_SANDBOX_SERVICE_URL, AIO_SERVICE_URL, RETURN_URL, CLIENT_BACK_URL, PAYMENT_INFO_URL
from muMDAU_app.pyallpay.setting import MERCHANT_ID
from muMDAU_app.pyallpay.setting import ALLPAY_SANDBOX
...
class AllPay():
    ...
    def __init__(self, payment_conf, service_method='post'):
        ...
        self.url_dict['IgnorePayment'] = 'Credit'
